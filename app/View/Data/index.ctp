<div class="data index">
	...
	<tr>
		...
		<td><?php echo h($data['Data']['name']); ?>&nbsp;</td>
		<td><?php echo h($data['Data']['message']); ?>&nbsp;</td>
		<td><?php echo h($data['Data']['created']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $data['Data']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $data['Data']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $data['Data']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $data['Data']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
